...
import { Sparkles, Brain, CheckCircle2, CircleAlert, AlertCircle } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Grounded narrative reasoning generated by verified provider ({explanation.providerName})
            </p>
          </div>
        </div>
