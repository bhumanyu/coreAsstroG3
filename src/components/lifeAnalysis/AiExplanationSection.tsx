...
export const AiExplanationSection: React.FC<AiExplanationSectionProps> = ({
  ...
  if (!explanation) {
    return (
      <section
        aria-labelledby="ai-explanation-empty-heading"
        className="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 text-center flex items-center justify-center gap-3 text-slate-400"
      >
        <Sparkles className="w-5 h-5 text-purple-400" aria-hidden="true" />
        <span id="ai-explanation-empty-heading" className="text-xs sm:text-sm font-medium text-slate-300">
  ...
  if (explanation.kind === 'ERROR') {
    return (
      <section
        aria-labelledby="ai-explanation-error-heading"
        className="bg-slate-900/90 border border-amber-500/30 rounded-2xl p-5 space-y-2"
      >
        <div className="flex items-center gap-2 text-amber-400 text-sm font-semibold">
          <AlertCircle className="w-4 h-4" aria-hidden="true" />
          <span id="ai-explanation-error-heading">AI Explanation Note</span>
        </div>
  ...
  return (
    <section
      ...
      className="bg-slate-900/90 border border-purple-500/30 rounded-2xl p-6 space-y-6 shadow-lg shadow-purple-500/5 relative overflow-hidden"
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 id="ai-explanation-heading" className="text-base sm:text-lg font-semibold text-slate-100">
