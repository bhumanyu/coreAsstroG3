...
export const DashaLoadingState: React.FC = () => {
  return (
    <div
      role="status"
      aria-busy="true"
    ...
    >
      <span className="sr-only">Analyzing Planetary Timing & Dasha Periods…</span>
      ...
      <div className="relative">
        ...
        <Clock className="w-4 h-4 text-purple-400 absolute -top-1 -right-1 animate-pulse" aria-hidden="true" />
      </div>

      <div className="space-y-1.5">
        <h3 className="text-base font-semibold text-slate-100">
          Analyzing Planetary Timing & Dasha Periods
        </h3>
        <p className="text-xs text-slate-400 max-w-md">
          Synthesizing Vimshottari Mahadasha, Antardasha, and Pratyantardasha hierarchy with domain activations and transit triggers...
        </p>
      </div>

      {/* Skeleton Preview Grid */}
      <div className="w-full max-w-2xl grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4 pt-4 border-t border-slate-800/60 opacity-60">
