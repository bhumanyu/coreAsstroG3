...
describe('Career Reasoning Hierarchy (Golden Scenarios C1-C7 & CW-01 Validation)', () => {
  ...
  it('X1: CW-01 is executed unconditionally with options', () => {
    const result = interpretCareerV2(canonicalHoroscope, makeOptions(canonicalHoroscope));
  ...
  it('X2: returns valid reasoning trace and CW-01 version on canonical chart', () => {
    const cw01Result = interpretCareerV2(canonicalHoroscope, makeOptions(canonicalHoroscope));
  ...
  describe('Manifestation Gating & Independence Resolution', () => {
    ...
    it('Deterministic horoscope independence evaluation using canonical birth details', () => {
      ...
      const result = interpretCareerV2(horoscope, makeOptions(horoscope));
